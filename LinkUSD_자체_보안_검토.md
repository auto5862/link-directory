# Link USD (LUSD) — 자체 보안 검토 체크리스트

**목적:** TronScan 감사 보고서 제출용 (전문 감사 없을 때 대안)  
**계약:** LinkUSD (TetherUSD_Pro.sol)  
**날짜:** 2026
...
| 항목 | 설명 |
|------|------|
| approve front-running | ERC20/TRC20 공통. approve 전 0으로 리셋 권장 (본 계약은 기본 구현) |
